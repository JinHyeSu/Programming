...
public class SwingDialogDELETERESERVATION_2OK extends JDialog {
	public SwingDialogDELETERESERVATION_2OK(RestaurantManager rm, int num) {
		super();
		...
		JLabel l6 = new JLabel("정말 취소하시겠습니까?" ,JLabel.CENTER);
		...
		add(no);
	} // SwingDialogDELETERESERVATION_2OK end
	...
	public void canSeat(Date date, String[] canSeat, String seat) {
		...
		if(minute_gap>60 && minute_gap<60) {
			canSeat[num]="X";
